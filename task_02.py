...
if __name__ == "__main__":
    input_image_path = r"C:\Users\Admin\Downloads\PRODIGY_CS_02-main\PRODIGY_CS_02-main\my image.png"
    img = Image.open(input_image_path)
    width, height = img.size
    key = np.random.randint(0, 329, size=(height, width, 3), dtype=np.uint8)  # 3 for RGB channels
